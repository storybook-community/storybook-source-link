...
STORY_WITH_BOTH_PARAMS.args = {
  ...
  notes:
    "No matter what parameters are set at Component or Preview level, Story level supersedes all.",
  details: `
${details}
...
STORY_WITH_ONLY_PREFIX.parameters = {
  sourceLinkPrefix:
    "https://raw.githubusercontent.com/Sirrine-Jonathan/storybook-source-link/main/src/stories/",
};
STORY_WITH_ONLY_PREFIX.args = {
  expectedLink:
    "https://raw.githubusercontent.com/Sirrine-Jonathan/storybook-source-link/main/src/stories/ManualTesting/Component.jsx",
  title: "STORY_WITH_ONLY_PREFIX",
  notes:
    "Here's what happens if you supply sourceLinkPrefix to the story, but not a sourceLink, leaving it to inherit from the component or preview.",
  details: `
${details}
